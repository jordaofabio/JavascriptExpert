...
// Internamente, objetos literais viram funções
...
console.log('obj.__proto__.__proto__ === null', obj.__proto__ === obj.__proto__.__proto__ === null);
...
// Podemos chamar via prototype, mas se tetar chamar direto dá erro!
console.log('Manager.prototype.salary()', Manager.prototype.salary());
// console.log('Manager.salary()', Manager.salary()); // esse que tá chamando direto dá erro
...
console.assert(Manager.prototype.__proto__, Supervisor.prototype)
...
console.log('manager.__proto__: %s, manager.salary(): %s', Manager.prototype.__proto__, new Manager().salary);
